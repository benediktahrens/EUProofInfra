...
\item Karl Palmskog <palmskog@gmail.com> 

\item Paul Jackson (not yet contacted)
...
\item Kevin Buzzard (not yet contacted)

\item Sébastien Gouëzel (not yet contacted)
\end{compactitem}
\end{framed}
...
\subsection{Open data / Open science}

Logipedia is clearly part of the Open data / Open science movement, as
it aims at making scientific data accessible to everyone, amateur or
professional, in academia, industry, and education.
...
movement of Open data and Open science.
Then the creative common licences promoted by Logipedia contribute also to
this movement.
